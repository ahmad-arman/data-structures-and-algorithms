...
const screenForNames = (arr) => {
  // Solution code here...
  let regPattern=[/Mrs. /g,/Mr. B/g,/Ms. B/g ,/Dr. B/g];

  let newNamesArr = [];
  arr.forEach(val=>{
    let i ;
    for( i=0;i<4;i++){
      if(regPattern[i].test(val)){
...
let biggerThanLuke = (arr) => {
  ...
  arr.forEach(element => {
    if(element.mass >100){
      ahmad.push(`${element.name}`);
    }

  });
  console.log(ahmad);
  let toString = ahmad.join(' - ');
  return toString;
};
...
const detectTicTacToeWin = (board) => {
  ...
  // console.log(merged);
  // if(merged[0]===merged[3] & merged[3]===merged[6]){
  //   return true;
  // }else if(merged[1]===merged[4]& merged[4]===merged[7]){
  //   return true;
  // }else if(merged[2]===merged[5]&merged[5]===merged[6]){
  //   return true;
  // }else if(merged[0]===merged[4]&merged[4]===merged[8]){
  //   return true;
  // }else if(merged[2]===merged[4]&merged[4]===merged[6]){
  //   return true;
  // }else if(merged[0]===merged[1]&merged[1]===merged[2]){
  //   return true;
  // }else if(merged[3]===merged[4]&merged[4]===merged[5]){
  //   return true;
  // }else if(merged[6]===merged[7]&merged[7]===merged[8]){
  //   return true;
  // }
  // else return false;
